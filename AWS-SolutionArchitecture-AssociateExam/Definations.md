...
​		a mesage is delivered once and remains available until a consurmer processses and deletes it. duplicates are not introduced into the queue.
...
Review Mode-4: Incorrect questions=> Question 18(EC2), 24(EBS)